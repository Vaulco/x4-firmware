...
void CrossPointWebServerActivity::render() const {
  ...
  if (state == WebServerActivityState::SERVER_RUNNING) {
    ...
    renderer.drawCenteredText(GfxRenderer::LARGE, pageHeight / 2 - 20, "Starting Hotspot...", true);
    renderer.displayBuffer();
  }
}
...
void CrossPointWebServerActivity::renderServerRunning() const {
  ...
  if (isApMode) {
    ...
    renderer.drawCenteredText(GfxRenderer::MEDIUM, startY + LINE_SPACING, ssidInfo.c_str());

    renderer.drawCenteredText(GfxRenderer::SMALL, startY + LINE_SPACING * 2, "Connect your device to this WiFi network");

    renderer.drawCenteredText(GfxRenderer::SMALL, startY + LINE_SPACING * 3,
    ...
    renderer.drawCenteredText(GfxRenderer::MEDIUM, startY + LINE_SPACING * 3, hostnameUrl.c_str(), true);

    // Show IP address as fallback
    std::string ipUrl = "or http://" + connectedIP + "/";
    renderer.drawCenteredText(GfxRenderer::SMALL, startY + LINE_SPACING * 4, ipUrl.c_str());
    renderer.drawCenteredText(GfxRenderer::SMALL, startY + LINE_SPACING * 5, "Open this URL in your browser");

    // Show QR code for URL
    renderer.drawCenteredText(GfxRenderer::SMALL, startY + LINE_SPACING * 6, "or scan QR code with your phone:");
    ...
    renderer.drawCenteredText(GfxRenderer::MEDIUM, startY, ssidInfo.c_str());

    std::string ipInfo = "IP Address: " + connectedIP;
    renderer.drawCenteredText(GfxRenderer::MEDIUM, startY + LINE_SPACING, ipInfo.c_str());

    // Show web server URL prominently
    std::string webInfo = "http://" + connectedIP + "/";
    renderer.drawCenteredText(GfxRenderer::MEDIUM, startY + LINE_SPACING * 2, webInfo.c_str(), true);

    // Also show hostname URL
    std::string hostnameUrl = std::string("or http://") + AP_HOSTNAME + ".local/";
    renderer.drawCenteredText(GfxRenderer::SMALL, startY + LINE_SPACING * 3, hostnameUrl.c_str());

    renderer.drawCenteredText(GfxRenderer::SMALL, startY + LINE_SPACING * 4, "Open this URL in your browser");
